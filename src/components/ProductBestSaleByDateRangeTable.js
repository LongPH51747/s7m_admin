...
const ProductBestSaleByDateRangeTable = ({ startDate, endDate }) => {
  ...
  return (
    <div style={{ width: '100%', maxWidth: 600, margin: '0 auto' }}>
      <h3 style={{ textAlign: 'center' }}>Top sản phẩm bán chạy nhất từ {startDate} đến {endDate}</h3>
...
export default ProductBestSaleByDateRangeTable;